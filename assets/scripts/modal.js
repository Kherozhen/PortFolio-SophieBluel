if(localStorage.getItem('token')){
  ...
  // Choisir la catégorie de la photo grâce à l'API
  ...
  function verification() {
    ...
    const categorieAjoutee = selectCategorie.value !== ''; // !== veut dire différent  => a voir pour le changer vu que j'ai mis une option vide
  ...
  okForAdd.addEventListener('click', () => {
